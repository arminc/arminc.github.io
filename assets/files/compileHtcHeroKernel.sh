...
echo "Setup evnironment variables....."
sleep 5
cd ~/myandroid/kernel_hero
export ARCH=arm
...
CONFIG_MSM_CPU_FREQ_SCALING_MIN=245760
CONFIG_MSM_HW3D=y
# CONFIG_MSM_ADSP is not set
CONFIG_MSM_ADSP_COMP=y
...
# CONFIG_TOUCHSCREEN_MELFAS_I2C is not set
# CONFIG_TOUCHSCREEN_TSSC_MANAGER is not set
CONFIG_TOUCHSCREEN_CY8CTST110=y
...
CONFIG_INPUT_GPIO=y
# CONFIG_INPUT_I2C_MATRIX is not set
...
CONFIG_SENSORS_S5K3E2FX=y
CONFIG_MICROP_I2C=y
# CONFIG_AMP_TPA6130A is not set
...
CONFIG_HAS_IOMEM=y
CONFIG_HAS_IOPORT=y
CONFIG_HAS_DMA=y" > ~/myandroid/kernel_hero/.config
